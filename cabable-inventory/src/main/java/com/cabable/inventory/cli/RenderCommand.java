package com.cabable.inventory.cli;
...
import com.cabable.inventory.CabableConfiguration;
import com.cabable.inventory.core.Template;

import java.util.Optional;

public class RenderCommand extends ConfiguredCommand<CabableConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<CabableConfiguration> bootstrap,
                       Namespace namespace,
                       CabableConfiguration configuration) throws Exception {
